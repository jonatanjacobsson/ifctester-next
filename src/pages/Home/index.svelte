                    ...
                    <Tooltip.Root disableHoverableContent="true">
                        <Tooltip.Trigger>
                            <button class="btn" aria-label="Bonsai Integration">
                                <svg style="height: 25px;" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="32mm" height="32mm" version="1.1" viewBox="0 0 32 32" xml:space="preserve">
